...
class VendasControllerTest < ActionController::TestCase
  ...
  test "should update venda" do
    put :update, id: @venda, venda: { cliente_id: @venda.cliente_id, codigo_cartao: @venda.codigo_cartao, desconto: @venda.desconto, num_cartao: @venda.num_cartao, produto_id: @venda.produto_id, quantidade: @venda.quantidade, tipo_pgt: @venda.tipo_pgt, validade_cartao: @venda.validade_cartao, valorVenda: @venda.valorVenda }
    assert_response 204
  end
